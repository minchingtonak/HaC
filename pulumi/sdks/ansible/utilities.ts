...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("ansible");
			params.setVersion("1.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2Fuc2libGUvYW5zaWJsZSIsInZlcnNpb24iOiIxLjMuMCJ9fQ=="), c => c.charCodeAt(0)));
